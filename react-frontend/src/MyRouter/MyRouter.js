...
import ObjectidPage from "../components/ObjectidPage/ObjectidPage";
import SingleObjectidPage from "../components/ObjectidPage/SingleObjectidPage";
// ~cb-add-import~
        ...
        <div className={wrapperClass} onClick={onWrapperClick}>
            ...
            <MainLayout>
                <Switch>
                    ...
                    <Route path="/string" component={StringPage} exact />
                    <Route path="/string/:singleStringId" component={SingleStringPage} exact />
                    <Route path="/boolean" component={BooleanPage} exact />
                    <Route path="/boolean/:singleBooleanId" component={SingleBooleanPage} exact />
                    <Route path="/number" component={NumberPage} exact />
                    <Route path="/number/:singleNumberId" component={SingleNumberPage} exact />
                    <Route path="/date" component={DatePage} exact />
                    <Route path="/date/:singleDateId" component={SingleDatePage} exact />
                    <Route path="/array" component={ArrayPage} exact />
                    <Route path="/array/:singleArrayId" component={SingleArrayPage} exact />
                    <Route path="/objectid" component={ObjectidPage} exact />
                    <Route path="/objectid/:singleObjectidId" component={SingleObjectidPage} exact />
                    {/* ~cb-add-route~ */}
